...
async function salvarProduto() {
    ...
    try {
        const response = await fetch("https://ecofarmaapiapi.azure-api.net/api/produto", {
            method: "POST",
...
async function carregarProdutos(pagina = 1) {
  try {
    ...
    let url = `https://ecofarmaapiapi.azure-api.net/api/produto/filtrar?pagina=${pagina}&tamanhoPagina=16`;
...
function buscarProdutos() {
    ...
    let url = `https://ecofarmaapiapi.azure-api.net/api/produto/filtrar?`;
