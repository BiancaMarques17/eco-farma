...
async function carregarDetalhesProduto(id) {
    try {
        const response = await fetch(`https://ecofarmaapiapi.azure-api.net/api/produto/${id}`);
...
async function enviarAvaliacao(data) {
    ...
    if (!usuarioLogado || !usuarioLogado.id_usuario) {
        ...
        try {
            const response = await fetch("https://ecofarmaapiapi.azure-api.net/api/avaliacao_produto", {
                method: "POST",
...
async function carregarAvaliacoes(idProduto) {
    try {
        const response = await fetch(`https://ecofarmaapiapi.azure-api.net/api/avaliacao_produto/produto/${idProduto}`);
...
if (nome && usuarioLogado?.id_usuario) {
    fetch(`https://ecofarmaapiapi.azure-api.net/api/cupom/cliente/${usuarioLogado.id_usuario}`)
...
async function buscarProdutos() {
    ...
    try {
        const response = await fetch(`https://ecofarmaapiapi.azure-api.net/api/produto/busca?termo=${encodeURIComponent(termo)}`);
