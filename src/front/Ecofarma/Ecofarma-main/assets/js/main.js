...
async function carregarProdutos(pagina = 1) {
  try {
    const response = await fetch(`https://ecofarmaapiapi.azure-api.net/api/produto?pagina=${pagina}&tamanhoPagina=8`);
...
async function carregarCuponsCliente() {
    ...
    const response = await fetch(`https://ecofarmaapiapi.azure-api.net/api/cupom/cliente/${idCliente}`);
