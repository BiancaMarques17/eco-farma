...
async function carregarProdutos(pagina = 1) {
  try {
    const response = await fetch(`http://ecofarma-f4ake0gkhwapfmh3.canadacentral-01.azurewebsites.net/api/produto?pagina=${pagina}&tamanhoPagina=8`);
...
async function carregarCuponsCliente() {
    ...
    const response = await fetch(`http://ecofarma-f4ake0gkhwapfmh3.canadacentral-01.azurewebsites.net/api/cupom/cliente/${idCliente}`);
